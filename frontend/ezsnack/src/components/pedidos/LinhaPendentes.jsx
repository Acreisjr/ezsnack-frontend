...
const LinhaPendentes = ({ alunoNome, itens, onAprovarClick, onNegarClick, onMaisDetalhesClick }) => {
  return (
...
LinhaPendentes.propTypes = {
  ...
  onNegarClick: PropTypes.func.isRequired,
};

export default LinhaPendentes;
